...
import com.yash.bank.Exception.NameInvalidException;
...
public class DBOperations {
	...
	public void insertAccount(long acno, String add, double b, String name, String panno) throws Exception {
		Connection con = DBUtil.getConnection();
		String insertEmployee = "insert into acount values(" + acno + ",'" + name + "','" + add + "'," + b + ",'"
				+ panno + "')";
		Statement stmt = con.createStatement();
	...
	public void selectAllRecord() throws Exception {
		...
		while (resultSet.next()) {
			...
			System.out.println();
			System.out.println(
					"acno: " + acno + " name: " + name + " addrres: " + add + " balance: " + bal + " panno: " + pan);
		}
	}
	...
	public void viewSigleRecord() throws Exception {
		...
		while (resultSet.next()) {
			...
			if (vacno == acno) {
				...
				double bal = resultSet.getDouble(4);
				String pan = resultSet.getString(5);
				System.out.println("acno: " + acno + " name: " + name + " addrres: " + add + " balance: " + bal
						+ " panno: " + pan);
			} else {
